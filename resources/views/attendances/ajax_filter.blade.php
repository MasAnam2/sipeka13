              ...
              <form action="{{ route('attendance.delete_selected') }}">
                <div class="row">
                  <div class="col-md-12 margin-bottom">
                    <div class="row">
                      <div class="col-md-2">
                        {{ print_link(route('attendance.print_filter', [$time])).excel_link(route('attendance.excel_filter', [$time])).pdf_link(route('attendance.pdf_filter', [$time])) }}
                      </div>
                      <div class="col-md-2">
                  ...
                  <div class="col-md-12">
                    <table id="datatable" data-url="{{ route('attendance.dt_filter', [$time]) }}" class="table table-bordered table-striped">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Employee</th>
